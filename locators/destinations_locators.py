...
max_voltage_power_click = '(//*[.="Слишком высокое напряжение сетевого питания"]//label/span)[1]'
max_voltage_power_status = '(//*[.="Слишком высокое напряжение сетевого питания"]//label/input)[1]'
min_voltage_power_click = '(//*[.="Слишком низкое напряжение сетевого питания"]//label/span)[1]'
min_voltage_power_status = '(//*[.="Слишком низкое напряжение сетевого питания"]//label/input)[1]'
...
Low_battery_zone_events_click = '(//*[.="Низкий заряд основного источника питания"]//label/span)[1]'
Low_battery_zone_events_status = '(//*[.="Низкий заряд основного источника питания"]//label/input)[1]'
water_sensor_loop_breakage_click = '(//*[.="Повреждение шлейфа счётчика воды"]//label/span)[1]'
water_sensor_loop_breakage_status = '(//*[.="Повреждение шлейфа счётчика воды"]//label/input)[1]'
...
Backup_battery_is_OK_zone_events_click = '(//*[.="Резервный источник питания в норме"]//label/span)[1]'
Backup_battery_is_OK_zone_events_status = '(//*[.="Резервный источник питания в норме"]//label/input)[1]'
...
sim_card_balance_reduced_click = '(//*[.="Баланс по симкарте снижен"]//label/span)[1]'
sim_card_balance_reduced_status = '(//*[.="Баланс по симкарте снижен"]//label/input)[1]'
...
added_sensor_click = '(//*[.="Добавлен датчик"]//label/span)[1]'
added_sensor_status = '(//*[.="Добавлен датчик"]//label/input)[1]'
user_added_or_changed_click = '(//*[.="Добавлен или изменен пользователь"]//label/span)[1]'
user_added_or_changed_status = '(//*[.="Добавлен или изменен пользователь"]//label/input)[1]'
key_added_click = '(//*[.="Добавлен ключ"]//label/span)[1]'
key_added_status = '(//*[.="Добавлен ключ"]//label/input)[1]'
added_or_changed_direction_click = '(//*[.="Добавлено или изменено направление"]//label/span)[1]'
added_or_changed_direction_status = '(//*[.="Добавлено или изменено направление"]//label/input)[1]'
...
key_updated_click = '(//*[.="Обновлён ключ"]//label/span)[1]'
key_updated_status = '(//*[.="Обновлён ключ"]//label/input)[1]'
sensor_removed_click = '(//*[.="Удалён датчик"]//label/span)[1]'
sensor_removed_status = '(//*[.="Удалён датчик"]//label/input)[1]'
key_removed_click = '(//*[.="Удалён ключ"]//label/span)[1]'
key_removed_status = '(//*[.="Удалён ключ"]//label/input)[1]'
user_removed_click = '(//*[.="Удалён пользователь"]//label/span)[1]'
user_removed_status = '(//*[.="Удалён пользователь"]//label/input)[1]'
