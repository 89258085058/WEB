...
data_gsm = ['Настройки GSM', 'Включить модуль GSM', 'Использовать GPRS', 'Использовать резервную SIM', 'Разрешить USSD',
            ...
            'Проверить', 'Включить запрос PIN', 'Сделать активной', 'Сохранить', 'SIM 1', 'SIM 2']
...
data_users = ['Общие настройки', 'Администратор', 'Режим Эгида3', 'Имя пользователя', 'Логин', 'Пароль',
              ...
              'Группа выходов с управлением по SMS', 'Группа выходов с управлением звонком', 'Управление через СМС',
              'Разрешить снятие по SMS', 'Разрешить взятие по SMS', 'Телефон', 'Пароль SMS', 'Повторите пароль',
              'Управляемые по SMS разделы', 'Отменить', 'Сохранить']
...
# Обнавления
update_device_text_content = ['Сигнал GSM Р исп. 0 изм.7', 'Текущая версия ПО', 'Сигнал GSM P:', 'Загрузчик',
