...
# Настройки/Прибор
data_device = ['Разрешить настройку при закрытом корпусе',
...
# Статус
radio_device_text_content = ['Радио устройства', 'Всего устройств', 'Отсутствует связь', 'Неисправность']
device_option_status_text_content = ['Прибор', 'Серийный номер', 'Корпус', 'Питание', 'Напряжение сети',
                                     'Заряд аккумулятора', 'Состояние аккумулятора']
cloud_server_text_content = ['Облачный сервер', 'Подключение', 'Сетевое подключение']
ethernet_status_text_content = ['Ethernet', 'MAC', 'IP', 'Статус']
gsm_status_text_content = ['Сотовая связь', 'GSM модуль', 'Уровень сигнала', 'Активная SIM', 'Состояние GSM',
                           'Состояние GPRS', 'SIM 1', 'SIM 2']


# Обнавления
update_device_text_content = ['Доп. информация', 'Загрузчик', 'Базовая', 'Радио', 'Сборка']
update_louder_text_content = 'Кликните сюда для выбора файла прошивки или перетащите его на страницу'
