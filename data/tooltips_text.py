...
login_tooltip_messege = 'Разрешен ввод: латинские буквы, числа, символы. Поле обязательно для заполнения. Минимальная длина: 4. Максимальная длина: 63.'
...
Settings_object_tooltip_messege_name_object = 'Текстовое обозначение объекта охраны, которое используется при трансляции событий в формате SMS.'
...
Settings_date_time_tooltip_message_manual_date_time = 'Выбор часового пояса вручную.'
Settings_date_time_tooltip_message_manual_date_and_time = 'Выбор даты и времени вручную.'
Settings_date_time_tooltip_message_time_zone = 'Выбор часового пояса вручную.'
...
text_Reader_operation_mode = "Первое касание - статус, последующие - взятие/снятие. Один светодиод: первое касание ключа отображает статус управляемых разделов, последующие касания до истечения таймаута взятие/снятие.\n Первое касание - статус, второе - взятие/снятие. Один светодиод: первое касание ключа отображает статус управляемых разделов, второе касание до истечения таймаута взятие/снятие. Третье касание будет аналогично первому.\n Первое касание - статус, последующие - взятие/снятие. Два светодиода: первый светодиод отображает реакцию на поднесение ключа, второй светодиод отображает статус управляемых разделов. В остальном поведение аналогично режиму с одним светодиодом.\n Первое касание - статус, второе - взятие/снятие. Два светодиода: первый светодиод отображает реакцию на поднесение ключа, второй светодиод отображает статус управляемых разделов. В остальном поведение аналогично режиму с одним светодиодом.\n Вывод статуса постоянно, касание - взятие/снятие. Два светодиода: первое и последующие касания ключа производят взятие/снятие разделов. Статус разделов всегда отображается вторым светодиодом. ВНИМАНИЕ! Режим рекомендуется только если у всех пользователей одинаковые права доступа к охранным и пожарным разделам."
...
text_vol_indication_Anxiety = 'Включение/выключение звуковой индикации тревоги в разделах, взятых на охрану.'
...
text_U_K_user_SMS_controlled_sections = 'Выпадающий список для выбора разделов системы, управление которыми разрешено данному пользователю.'
...
# --------------------ПОЛЯ ВВОДА--------------------------------------------
input_max_len_31 = 'Максимальная длина: 63 байта.'
input_numbers_1_9999 = 'Разрешен ввод только цифр. Минимальное значение: 1. Максимальное значение: 9999.'
input_numbers_1_99 = 'Разрешен ввод только цифр. Минимальное значение: 1. Максимальное значение: 99. Нельзя выбрать используемый номер раздела'
input_numbers_1_9999_num = 'Разрешен ввод только цифр. Поле обязательно для заполнения. Минимальное значение: 1. Максимальное значение: 999999.'
...
input_server_address_23 = 'Разрешен ввод: латинские буквы, числа, ".", "-". Максимальная длина: 31.'
...
input_1_65535_not_necessary = 'Разрешен ввод только цифр. Поле обязательно для заполнения. Минимальное значение: 1. Максимальное значение: 65535.'
...
input_PIN = 'Разрешен ввод только цифр. Минимальное количество чисел: 4. Максимальное количество чисел: 8.'
...
input_mac_address = 'Разрешен ввод: шестнадцатеричные цифры, ":", "-". Максимальная длина: 17.'
...
input_login = 'Разрешен ввод: латинские буквы, числа, символы. Минимальная длина: 4. Максимальная длина: 63.'
input_password_necessary = 'Разрешен ввод: латинские буквы, цифры, символы. Поле обязательно для заполнения. Минимальная длина: 4. Максимальная длина: 63.'
...
input_password_5 = 'Разрешен ввод: цифры. Максимальная длина: 5.'
...
input_name_31 = 'Разрешен ввод: Русские буквы, латинские буквы, спецсимволы, цифры. Максимальная длина: 63 байта'
input_63 = 'Поле обязательно для заполнения. Максимальная длина: 95 байт.'
