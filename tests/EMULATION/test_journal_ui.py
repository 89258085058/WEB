...
class TestUIJournalChapter2:
    ...
    @pytest.mark.parametrize("value_status, description",
                             [
                                 (0, 'Событие передано'),
                                 (4008, 'Ошибка передачи'),
                                 (4009, 'Передача не удалась'),
                                 (4011, 'Отсутствует направление'),
                                 (4012, 'Повторная попытка отправки'),
                                 (4015, 'Абонент не отвечает')
                             ])
...
class TestUIJournalChapter3:
    ...
    @pytest.mark.parametrize("value_out_event_type, description_out_event_type, value, description",
                             [
                                 ...
                                 (1, 'Событийное', 1, 'Неисправность'),
                                 (1, 'Событийное', 5, 'Раздел не используется'),
                                 (1, 'Событийное', 6, 'Невзятие'),
                                 (1, 'Событийное', 7, 'Ожидание квитанции'),
                                 (1, 'Событийное', 8, 'Раздел снят'),
                                 (1, 'Событийное', 9, 'Автовзятие'),
                                 (1, 'Событийное', 10, 'Задержка взятия'),
                                 (1, 'Событийное', 11, 'Принудительное взятие раздела'),
                                 (1, 'Событийное', 15, 'Квитанция получена'),
                                 (1, 'Событийное', 16, 'Раздел взят'),
                                 (1, 'Событийное', 17, 'Тревога входа'),
                                 (1, 'Событийное', 21, 'Тревога'),
                                 (1, 'Событийное', 22, 'Пожара нет'),
                                 (1, 'Событийное', 23, 'Пожара нет по ручному извещателю'),
                                 (1, 'Событийное', 24, 'Пожар'),
                                 (1, 'Событийное', 25, 'Пожар по ручному извещателю'),
                                 (1, 'Событийное', 29, 'Тихая тревога'),
                                 (1, 'Событийное', 30, 'Включение выхода'),
                                 (1, 'Событийное', 31, 'Выключение выхода'),
                                 (1, 'Событийное', 32, 'Отметка наряда'),
                                 (1, 'Событийное', 33, 'Протечка воды'),
                                 (1, 'Событийное', 40, 'Сброс оповещателей тревоги и пожара'),
                                 (1, 'Событийное', 41, 'Переключение выхода'),
    ...
    @pytest.mark.parametrize("value_sys_evt_type, description_sys_evt_type",
                             [
                                 ...
                                 (15, 'Соединение с сервером установлено'),
                                 (16, 'Соединение с сервером потеряно'),
                                 (17, 'Соединение с сервером восстановлено')
                             ])
    ...
    @pytest.mark.parametrize("value_sys_evt_type, description_sys_evt_type, value_state, value_description",
                             [
                                 (11, 'Открытие корпуса прибора', 0, 'Вскрытие корпуса'),
                                 (12, 'Закрытие корпуса прибора', 1, 'Закрытие корпуса')
                             ])
    @pytest.mark.parametrize("p_event, description",
                             [
                                 (2, 'Невзятие'),
...
# *********************************************************************************************************************
    ...
    def test_field_search_validation(self, app, extend_time, open_tab_journal):
