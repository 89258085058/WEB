...
class TestUsersKeysValidation():
    ...
    def test_user_input_search_user(self, app):
        with allure.step("Переход на страницу Пользователи и ключи"):
            app.PO_Navigations.goToUsersKeysPage()
    ...
    def test_user_input_name_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_login_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_login_user_negativ(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_password_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_password_user_negativ(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_re_password_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_re_password_user_negativ(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_phone_cod_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_phone_cod_user_negativ(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_phone_number_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_password_sms_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_phone_password_sms_negativ(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_password_sms_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Повторите пароль'(Добавить пользователя)")
    def test_user_input_re_password_sms_user(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_re_password_sms_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Повторите пароль'(Добавить пользователя)")
    def test_user_input_phone_re_password_sms_negativ(self, app, users, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_user_input_name_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_name_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Имя пользователя'(Настройки)")
    def test_user_input_name_user_negativ_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_name_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Логин'(Настройки)")
    def test_user_input_login_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_login_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Логин'(Настройки)")
    def test_user_input_login_user_negativ_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_login_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Пароль'(Настройки)")
    def test_user_input_password_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_password_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Пароль'(Настройки)")
    def test_user_input_password_user_negativ_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_password_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Повторите пароль'(Настройки)")
    def test_user_input_re_password_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_re_password_user()
    ...
    def test_user_input_phone_cod_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_phone_cod_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Телефон (КОД)'(Настройки)")
    def test_user_input_phone_cod_user_negativ_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_phone_cod_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Телефон (номер)'(Настройки)")
    def test_user_input_phone_number_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_phone_number_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Телефон (номер)'(Настройки)")
    def test_user_input_phone_number_user_negativ_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_phone_number_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Пароль SMS'(Настройки)")
    def test_user_input_password_sms_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_password_sms_user()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Пароль SMS'(Настройки)")
    def test_user_input_phone_password_sms_negativ_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_password_sms_user_negativ()

    @allure.story("ПОЛЬЗОВАТЕЛИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Повторите пароль'(Настройки)")
    def test_user_input_re_password_sms_user_settings(self, app, users_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_re_password_sms_user()
    ...
    @allure.story("КЛЮЧИ")
    @allure.title("Позитивные сценарии: Проверка ввода значений в поле 'Поиск'")
    def test_input_search_keys(self, app):
        with allure.step("Переход на страницу Пользователи и ключи"):
            app.PO_Navigations.goToUsersKeysPage()
        with allure.step("Переход на вкладку 'Ключи'"):
            app.PO_Navigations.goToKeysPage()
    ...
    def test_input_keys_id(self, app, keys, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_input_keys_id_negativ(self, app, keys, close_modal):
        with allure.step("Проверка валидации поля"):
    ...
    def test_input_keys_id_settings(self, app, keys_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_key_id()

    @allure.story("КЛЮЧИ")
    @allure.title("Негативные сценарии: Проверка ввода значений в поле 'Идентификатор'(Настройки ключа)")
    def test_input_keys_id_negativ_settings(self, app, keys_settings, close_modal):
        with allure.step("Проверка валидации поля"):
            app.PO_Users_Keys.input_key_id_negativ()
